...
class UtilsTest(ToilTest):
    ...
    def testAWSProvisionerUtils(self):
        ...
        try:
            system([self.toilMain, 'launch-cluster', '--nodeType=t2.micro', '--keyPairName=cketchum@ucsc.edu',
        ...
        try:
            ...
            system([self.toilMain, 'launch-cluster', '--nodeType=m3.medium:0.5', '--keyPairName=cketchum@ucsc.edu',
